...
int main()  {
  ...
  // char* test_str_1 = last_state("-@@------@--@-");
  // free(test_str_1);

  // char* test_str_2 = last_state("---@--@--@--");
  // free(test_str_2);

  // char* test_str_3 = last_state("---@----@---@-");
  // free(test_str_3);

  // char* test_str_4 = last_state("-@-@-@-@-----@--@--@-");
  // free(test_str_4);

  // char* test_str_5 = last_state("---@----------");
  // free(test_str_5);

  // printf("%i\n", add_user_password("test.db", "maya", "password123"));
  // printf("%i\n", check_user_password("test.db", "maya", "password123"));
